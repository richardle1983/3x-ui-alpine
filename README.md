...
# 官方功能移植列表:
  ...
  4. Legacy Version - 安装制定版本: 已完成(2024/12/16)
  ...
  10. View Current Settings - 查看面板配置: 已完成(2024/12/16)
  ————————————————
  ...
  22. SSH Port Forwarding Management - 防火墙管理: 开发中......
  ————————————————
